...
void example_1()
{
    ...
    avl_tree<int, string> *tree = new avl_tree<int, string>(comparator_int);
    try
    {
...
void example_2()
{
    ...
    avl_tree<string, string> *tree = new avl_tree<string, string>(comparator_string);
    try
    {
...
void example_3()
{
    ...
    comparator<int> *comparator_int = new comparator<int>;
    avl_tree<int, string> *tree = new avl_tree<int, string>(comparator_int);
    avl_tree<int, string> *tree_copy = new avl_tree<int, string>(comparator_int);
    cout << "An instance of avl tree named \"tree\"" << endl;
    ...
    tree->prefix_traversal(print<int, string>);
    cout << endl;
    cout << "An instance of avl tree named \"tree_copy\"" << endl;
