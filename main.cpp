...
void example_1()
{
    ...
    rb_tree<int, string> *tree = new rb_tree<int, string>(comparator_int);
    try
    {
...
void example_2()
{
    ...
    rb_tree<string, string> *tree = new rb_tree<string, string>(comparator_string);
    try
    {
...
void example_3()
{
    ...
    comparator<int> *comparator_int = new comparator<int>;
    rb_tree<int, string> *tree = new rb_tree<int, string>(comparator_int);
    rb_tree<int, string> *tree_copy = new rb_tree<int, string>(comparator_int);
    cout << "An instance of a rbtree named \"tree\"" << endl;
    ...
    tree->prefix_traversal(print<int, string>);
    cout << endl;
    cout << "An instance of a rbtree named \"tree_copy\"" << endl;
